...
data = np.asarray([[sheet.row_values(i)[1],sheet.row_values(i)[2],sheet.row_values(i)[3]] for i in range(1, sheet.nrows)])
...
with tf.Session() as sess:
    ...
    for i in range(60):  # train the model 50 epochs
        total_loss = 0
        for x, y, z in data:
